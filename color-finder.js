...
function ResultsTable({
  ...
  const filtered = matches.filter(p => (activeFinishes.length === 0 || activeFinishes.includes(p.finish)) && (activeBrands.length === 0 || activeBrands.includes(p.brand)) && (activeTones.length === 0 || activeTones.includes(toneOf(p))));
  ...
  })))), allFinishes.length > 1 && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexWrap: 'wrap',
      gap: 6,
  ...
  }, "Clear")), (activeFinishes.length > 0 || activeBrands.length > 0 || activeTones.length > 0) && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 10,
...
function TweaksPanel({
  ...
  }, "Matches Shown"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 10,
  ...
  }, tweaks.matchCount)), /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'block',
      marginBottom: 6,
      color: 'var(--text-muted)',
...
function App() {
  ...
  const wheelColors = React.useMemo(() => {
    ...
    })).sort((a, b) => a.dist - b.dist).slice(0, NEIGHBORS).map(x => x.c);
  }, [colors, zoomAnchor]);
  ...
  }, "Showing the 11 closest shades to your selection"))), selectedColor && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 28,
      display: 'flex',
      alignItems: 'center',
